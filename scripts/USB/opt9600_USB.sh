...
#  USB stick for these Opticum/Orton:"
#  - HD 9600
#  - HD 9600 TS
#  - HD 9600 Mini
#  - HD 9600 Prima
...
echo -n " - Prepare kernel flash file..."
...
# Create a ext2 partition for the complete root
cd $TMPROOTDIR
$MKFSEXT2 -q -F -L $IMAGE $OUTDIR/root.img
