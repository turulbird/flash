...
$TOOLSDIR/mkdnimg -debug -make usbimg -vendor_id 0x00444753 -product_id 0x6c6f6f6b -hw_model $HWMODEL -hw_version $HWVERSION -start_addr 0xa0040000 -erase_size $ERASE_SZ -image_name all_noboot -input out_tmp1.img -output $OUTFILE
rm -f out_tmp.img
rm -f out_tmp1.img
echo " done."
