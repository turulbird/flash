...
# "disk (either USB or later built in) on a Homecast HS8100 CI series"
# "model."
# "Author: Audioniek"
...
# ---------------------------------------------------------------------------
# Changes:
# 20230501 Audioniek   Initial version.
#
...
cp $INSTALLERDIR/hchs8100/Image_Installer.ini $OUTDIR
cp $INSTALLERDIR/hchs8100/uImage $OUTDIR
