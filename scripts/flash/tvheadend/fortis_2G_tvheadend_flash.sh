#!/bin/bash
# "-----------------------------------------------------------------------"
# " This script creates flashable Tvheadend images for Fortis receivers:"
# " - HS7110
# " - HS7420
# " - HS7810A
...
#
# "-----------------------------------------------------------------------"
# "It is assumed that a Tvheadend image was already built prior to"
...
# the squashfs dummy only, leaving the Tvheadend part of it untouched.
#
