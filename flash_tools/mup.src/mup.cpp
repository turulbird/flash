...
{ 
	...
	if (argc == 3 && strlen(argv[1]) == 2 && !strncmp(argv[1], "-i", 2))
	{
		doInfo = true;
	}
	else if (argc == 3 && strlen(argv[1]) == 2 && !strncmp(argv[1], "-v", 2))
	{
		doVerify = true;
	}
	else if (argc == 3 && strlen(argv[1]) == 2 && !strncmp(argv[1], "-x", 2))
	{
		doXML = true;
	}
	else if (argc == 3 && strlen(argv[1]) == 3 && !strncmp(argv[1], "-xx", 3))
	{
		doXMLDetail = true;
	}
#if 0
	...
	else if (argc == 3 && strlen(argv[1]) == 3 && !strncmp(argv[1], "-cs", 3))
	{
		verbose = false;
		doCreate = true;
	}
